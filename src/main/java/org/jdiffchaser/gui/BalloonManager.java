...
/**
 * Note that this class is extensively inspired 
 * from the jna com.sun.jna.examples.BalloonManager
 */
...
public class BalloonManager {
    ...
    private static final class BubbleWindow extends JWindow {
        ...
        public BubbleWindow(Window owner, Component content, boolean useDropShadowIfSupported) {
            super(owner);
            setFocusableWindowState(false);
            setName("###overrideRedirect###");
            ...
            if (useDropShadowIfSupported && useDropShadow()) {
     ...
     * are absolute.
     */
    public static JWindow getBalloonWindow(final Component owner, final Component content, int x, int y, 
                                           boolean useDropShadowIfSupported) {

        final Window parent = owner != null 
            ? SwingUtilities.getWindowAncestor(owner) : null;
        BubbleWindow w = new BubbleWindow(parent, content, useDropShadowIfSupported);
        w.pack();
    ...
    public static void setWindowLocation(Component owner, JWindow w, int x, int y){
