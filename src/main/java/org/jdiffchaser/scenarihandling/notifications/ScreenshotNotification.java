...
package org.jdiffchaser.scenarihandling.notifications;

import javax.management.Notification;


public class ScreenshotNotification extends Notification{
    
    public ScreenshotNotification(String type, Object source, int sequenceNumber) {
