...
import org.jdiffchaser.imgprocessing.ScreenshotDoneListener;
import org.jdiffchaser.imgprocessing.ScreenshotException;

public interface RecorderMBean {
    ...
    public void handleComparison(boolean fullScreen, long delay) throws ScreenshotException; 
